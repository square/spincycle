...
//////////////////////////////////////////////////////
//////////////////////////////////////////////////////
// Some helpful helper functions for testing
//////////////////////////////////////////////////////
...
func (t testNode) Create(args map[string]interface{}) error {
	t.givenArgs = map[string]interface{}{}
	for k, v := range args {
		t.givenArgs[k] = v
	}
	return nil
...
func (t testNode) Serialize() ([]byte, error) {
	return nil, nil
}
...
var tnf = &testNodeFactory{}

func (tnf *testNodeFactory) Make(jobType, jobName string) (testNode, error) {
	return testNode{
		name:      jobName,
		ty:        jobType,
		givenArgs: map[string]interface{}{},
...
func g1() *Graph {
	n1, _ := tnf.Make("g1n1", "g1n1")
	n2, _ := tnf.Make("g1n2", "g1n2")
	n3, _ := tnf.Make("g1n3", "g1n3")
	g1n1 := &Node{Datum: n1}
	g1n2 := &Node{Datum: n2}
	g1n3 := &Node{Datum: n3}
...
//
func g3() *Graph {
	n1, _ := tnf.Make("g3n1", "g3n1")
	n2, _ := tnf.Make("g3n2", "g3n2")
	n3, _ := tnf.Make("g3n3", "g3n3")
	n4, _ := tnf.Make("g3n4", "g3n4")
	g3n1 := &Node{Datum: n1}
	g3n2 := &Node{Datum: n2}
	g3n3 := &Node{Datum: n3}
	g3n4 := &Node{Datum: n4}
